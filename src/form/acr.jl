...
""
function constraint_mc_power_balance_shunt_slack(pm::_PMs.AbstractACRModel, n::Int, c::Int, i::Int, bus_arcs, bus_arcs_dc, bus_gens, bus_pd, bus_qd, bus_gs, bus_bs)
...
""
function constraint_mc_power_balance_shunt_trans(pm::_PMs.AbstractACRModel, nw::Int, c::Int, i::Int, bus_arcs, bus_arcs_dc, bus_arcs_trans, bus_gens, bus_pd, bus_qd, bus_gs, bus_bs)
...
""
function constraint_mc_power_balance_shunt_trans_load(pm::_PMs.AbstractACRModel, nw::Int, c::Int, i::Int, bus_arcs, bus_arcs_dc, bus_arcs_trans, bus_gens, bus_loads, bus_gs, bus_bs)
    vr = _PMs.var(pm, nw, c, :vr, i)
    vi = _PMs.var(pm, nw, c, :vi, i)
    p = _PMs.var(pm, nw, c, :p)
    q = _PMs.var(pm, nw, c, :q)
