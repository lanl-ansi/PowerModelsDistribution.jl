""
function run_mc_opf_bctr(data::Dict{String,Any}, model_constructor, solver; kwargs...)
    return _PMs.run_model(data, model_constructor, solver, post_mc_opf_bctr; multiconductor=true, solution_builder=solution_bctr!, ref_extensions=[ref_add_arcs_trans!], kwargs...)
end


""
function run_mc_opf_bctr(file::String, model_constructor, solver; kwargs...)
    return run_mc_opf_bctr(PowerModelsDistribution.parse_file(file), model_constructor, solver; kwargs...)
end
