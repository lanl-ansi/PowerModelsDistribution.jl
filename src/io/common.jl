...
function wrapto180(degrees::MultiConductorVector)
    MultiConductorVector(wrapto180(degrees[:]))
end
...
function wraptopi(degrees::MultiConductorVector)
    MultiConductorVector(wraptopi(degrees[:]))
end
