...
@testset "test sdp distflow opf_bf" begin
    ...
    @testset "5-bus independent radial different case" begin
        ...
        @test isapprox(result["solution"]["gen"]["1"]["qg"][1],   0.2362121; atol = 1e-2)
        @test isapprox(result["solution"]["gen"]["1"]["qg"][2],  -0.0219214; atol = 1e-2)
        @test isapprox(result["solution"]["gen"]["1"]["qg"][3],  -0.0249553; atol = 1e-2)
