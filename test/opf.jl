...
@testset "test opf" begin
    @testset "test matpower opf" begin
        case5 = PMs.parse_file("../test/data/matpower/case5.m")
        case30 = PMs.parse_file("../test/data/matpower/case30.m")

        PMD.make_multiconductor!(case5, 3)
        PMD.make_multiconductor!(case30, 3)

        @testset "5-bus matpower acp opf" begin
            result = run_mc_opf(case5, PMs.ACPPowerModel, ipopt_solver)
        ...
        @testset "5-bus matpower acr opf" begin
            result = run_mc_opf(case5, PMs.ACRPowerModel, ipopt_solver)
        ...
        @testset "30-bus matpower acp opf" begin
            result = run_mc_opf(case30, PMs.ACPPowerModel, ipopt_solver)
        ...
        @testset "30-bus matpower acr opf" begin
            result = run_mc_opf(case30, PMs.ACRPowerModel, ipopt_solver)
        ...
        @testset "30-bus matpower dcp opf" begin
            result = run_mc_opf(case30, PMs.DCPPowerModel, ipopt_solver)
        ...
        @testset "30-bus matpower nfa opf" begin
            result = run_mc_opf(case30, PMs.NFAPowerModel, ipopt_solver)
    ...
    @testset "test dropped phases opf" begin
        case4_phase_drop = PMD.parse_file("../test/data/opendss/case4_phase_drop.dss"; data_model="mathematical")
        ...
        @testset "4-bus phase drop acp opf" begin
            result = run_mc_opf(case4_phase_drop, PMs.ACPPowerModel, ipopt_solver)
        ...
        @testset "4-bus phase drop acr opf" begin
            result = run_mc_opf(case4_phase_drop, PMs.ACRPowerModel, ipopt_solver)
        ...
        @testset "5-bus phase drop acp opf" begin
            ...
            result = run_mc_opf(case5_phase_drop, PMs.ACPPowerModel, ipopt_solver)
        ...
        @testset "5-bus phase drop acr opf" begin
            result = run_mc_opf(case5_phase_drop, PMs.ACRPowerModel, ipopt_solver)
        ...
        @testset "5-bus phase drop dcp opf" begin
            result = run_mc_opf(case5_phase_drop, PMs.DCPPowerModel, ipopt_solver)
        ...
        @testset "5-bus phase drop nfa opf" begin
            result = run_mc_opf(case5_phase_drop, PMs.NFAPowerModel, ipopt_solver)
    ...
    @testset "test opendss opf" begin
        ...
        @testset "3-bus unbalanced isc acp opf" begin
            pmd = PMD.parse_file("../test/data/opendss/case3_balanced_isc.dss"; data_model="mathematical")
            sol = PMD.run_mc_opf(pmd, PMs.ACPPowerModel, ipopt_solver)
        ...
        @testset "3-bus balanced pv acp opf" begin
            pmd = PMD.parse_file("../test/data/opendss/case3_balanced_pv.dss"; data_model="mathematical")
        ...
        @testset "3-bus unbalanced single-phase pv acp opf" begin
            pmd = PMD.parse_file("../test/data/opendss/case3_unbalanced_1phase-pv.dss"; data_model="mathematical")
            sol = PMD.run_mc_opf(pmd, PMs.ACPPowerModel, ipopt_solver)
        ...
        @testset "3-bus balanced capacitor acp opf" begin
            pmd = PMD.parse_file("../test/data/opendss/case3_balanced_cap.dss"; data_model="mathematical")
        ...
        @testset "3w transformer nfa opf" begin
            mp_data = PMD.parse_file("../test/data/opendss/ut_trans_3w_dyy_1.dss"; data_model="mathematical")
